...
confidence_interval = [ynoise_const - ynoise_noise, ynoise_const + ynoise_noise];
% calculate ex7_2num for using 'K' as the title and ynoise_const and confidence_interval as the arguments
text1 = ex7_2num('K', ynoise_const, confidence_interval);
...
% calculate confidence interval
confidence_interval2 = [ynoise_const2 - ynoise_noise2, ynoise_const2 + ynoise_noise2];
% calculate ex7_2num for using 'K' as the title and ynoise_const2 and confidence_interval2 as the arguments
text2 = ex7_2num('K', ynoise_const2, confidence_interval2);
% plot asymptote as black line
line_x2 = [x(index_ynoise2), x(end)];
line_y2 = [ynoise_const2, ynoise_const2];
plot(line_x2, line_y2, 'k-');
legend('data', text1, text2, 'Location', 'southeast');
hold off
